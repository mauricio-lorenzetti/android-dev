package com.mauk.app.sharedpreferencesexample;
...
import com.mauk.app.sharedpreferencesexample.fragment.FavoriteListFragment;
import com.mauk.app.sharedpreferencesexample.fragment.ProductListFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (fragmentManager.findFragmentByTag(ProductListFragment.ARG_ITEM_ID) != null) {
                pdtListFragment = (ProductListFragment) fragmentManager.findFragmentByTag(ProductListFragment.ARG_ITEM_ID);
