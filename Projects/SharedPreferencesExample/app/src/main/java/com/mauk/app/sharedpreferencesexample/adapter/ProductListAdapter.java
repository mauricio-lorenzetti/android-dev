package com.mauk.app.sharedpreferencesexample.adapter;
...
public class ProductListAdapter extends ArrayAdapter<Product> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.productDescTxt = (TextView) convertView.findViewById(R.id.txt_pdt_desc);
            holder.productPriceTxt = (TextView) convertView.findViewById(R.id.txt_pdt_price);
